...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        r.setContacts(ContactType.TEL, new ContactData("+7(921) 855-0482", ""));
        r.setContacts(ContactType.SKYPE, new ContactData("grigory.kislin", "skype:grigory.kislin"));
        r.setContacts(ContactType.MAIL, new ContactData("gkislin@yandex.ru", "mailto:gkislin@yandex.ru"));
        r.setContacts(ContactType.PROFILE, new ContactData("Профиль LinkedIn", "https://www.linkedin.com/in/gkislin"));
        r.setContacts(ContactType.PROFILE, new ContactData("Профиль GitHub", "https://github.com/gkislin"));
        r.setContacts(ContactType.PROFILE, new ContactData("Профиль Stackoverflow", "https://stackoverflow.com/users/548473"));
        r.setContacts(ContactType.LINK, new ContactData("Домашняя страница", "http://gkislin.ru/"));

        r.setSections(SectionType.OBJECTIVE, new SectionText("Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям."));
        r.setSections(SectionType.PERSONAL, new SectionText("Аналитический склад ума, сильная логика, креативность, инициативность. Пурист кода и архитектуры."));
        ...
        r.setSections(SectionType.ACHIEVEMENTS, new SectionListText(achievements));

        List<String> qualifications = new ArrayList<>(); //qualifications
        ...
        r.setSections(SectionType.QUALIFICATIONS, new SectionListText(qualifications));

        List<Content> experience = new ArrayList<>();
        experience.add(new Content(
        ...
        r.setSections(SectionType.EXPERIENCE, new SectionListContent(experience));

        List<Content> education = new ArrayList<>();
        education.add(new Content(
        ...
        r.setSections(SectionType.EDUCATION, new SectionListContent(education));
